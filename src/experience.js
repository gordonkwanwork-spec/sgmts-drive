...
const asset=f=>import.meta.env.BASE_URL+'assets/'+f+(['art.glb','street-kit.glb'].includes(f)?'?v=streets-gait-20260924':f.startsWith('station-')?'?v=stations-20260923b':'');
...
function toast(text,seconds=4){$('#toast').textContent=text;$('#toast').classList.add('visible');toastTime=seconds;}
...
// ponytail: desktop keyboard/mouse only; mobile needs a touch joystick before on-foot is exposed there.
