// All audio is synthesised with WebAudio — placeholder sound design.
// To substitute real recordings, drop files in public/audio/ and replace the
// corresponding play* function with an AudioBufferSourceNode player.
...
export function initAudio() { ensure(); if (ctx?.state === 'suspended') ctx.resume(); }
...
export function setMuted(muted) { if(master) master.gain.value = muted ? 0 : 0.55; }
